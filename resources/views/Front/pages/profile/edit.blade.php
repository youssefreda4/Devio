            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="site-heading d-flex align-items-center justify-content-center text-center">
                    ...
                    <div class="profile-image-wrapper me-3">
                        <img src="{{ $user->image() }}" alt="Profile Image" class="profile-image rounded-circle" width="300px" height="250px">
                    </div>
                    <div>
...
<div class="container">
    <div class="row">
        <div class="col-12 mx-auto mt-3 mb-5">
            <x-error></x-error>
            <x-success></x-success>
            <form action="{{ route('front.profile.update',$user->id) }}" method="POST" class="form border rounded p-3" enctype="multipart/form-data">
                @method('PUT')
                @csrf
